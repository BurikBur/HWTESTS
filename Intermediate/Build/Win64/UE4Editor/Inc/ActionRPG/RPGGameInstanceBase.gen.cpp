...
// Cross Module References
	...
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_AddDefaultInventory();
	ACTIONRPG_API UClass* Z_Construct_UClass_URPGSaveGame_NoRegister();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_GetCurrentSaveGame();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_GetSaveSlotInfo();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_HandleSaveGameLoaded();
	ENGINE_API UClass* Z_Construct_UClass_USaveGame_NoRegister();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_IsValidItemSlot();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_LoadOrCreateSaveGame();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_ResetSaveGame();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_SetSavingEnabled();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGGameInstanceBase_WriteSaveGame();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS(URPGGameInstanceBase, 2118497854);
