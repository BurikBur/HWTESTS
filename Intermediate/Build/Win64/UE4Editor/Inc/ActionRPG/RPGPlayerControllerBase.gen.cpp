...
// Cross Module References
	...
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_AddInventoryItem();
	ACTIONRPG_API UClass* Z_Construct_UClass_URPGItem_NoRegister();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_FillEmptySlots();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_GetInventoryItemCount();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_GetInventoryItemData();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGItemData();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_GetInventoryItems();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FPrimaryAssetType();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_GetSlottedItem();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_GetSlottedItems();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_InventoryItemChanged();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_LoadInventory();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_RemoveInventoryItem();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_SaveInventory();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_SetSlottedItem();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGPlayerControllerBase_SlottedItemChanged();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ARPGPlayerControllerBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ARPGPlayerControllerBase_GetInventoryItems, "GetInventoryItems" }, // 1541605700
		{ &Z_Construct_UFunction_ARPGPlayerControllerBase_GetSlottedItem, "GetSlottedItem" }, // 2724262713
		{ &Z_Construct_UFunction_ARPGPlayerControllerBase_GetSlottedItems, "GetSlottedItems" }, // 422294319
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_SlottedItems = { "SlottedItems", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGPlayerControllerBase, SlottedItems), METADATA_PARAMS(Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_SlottedItems_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_SlottedItems_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_InventoryData = { "InventoryData", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGPlayerControllerBase, InventoryData), METADATA_PARAMS(Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_InventoryData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGPlayerControllerBase_Statics::NewProp_InventoryData_MetaData)) };
	...
	IMPLEMENT_CLASS(ARPGPlayerControllerBase, 373189555);
