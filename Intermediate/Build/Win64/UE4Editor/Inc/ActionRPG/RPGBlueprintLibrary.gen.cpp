...
// Cross Module References
	...
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_AddTargetsToEffectContainerSpec();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGGameplayEffectContainerSpec();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_ApplyExternalEffectContainerSpec();
	GAMEPLAYABILITIES_API UScriptStruct* Z_Construct_UScriptStruct_FActiveGameplayEffectHandle();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_DoesEffectContainerSpecHaveEffects();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_DoesEffectContainerSpecHaveTargets();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_EqualEqual_RPGItemSlot();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_GetProjectVersion();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_IsInEditor();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_IsValidItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_NotEqual_RPGItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_PlayLoadingScreen();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_URPGBlueprintLibrary_StopLoadingScreen();
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URPGBlueprintLibrary_AddTargetsToEffectContainerSpec_Statics::NewProp_HitResults = { "HitResults", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RPGBlueprintLibrary_eventAddTargetsToEffectContainerSpec_Parms, HitResults), METADATA_PARAMS(Z_Construct_UFunction_URPGBlueprintLibrary_AddTargetsToEffectContainerSpec_Statics::NewProp_HitResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URPGBlueprintLibrary_AddTargetsToEffectContainerSpec_Statics::NewProp_HitResults_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URPGBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URPGBlueprintLibrary_AddTargetsToEffectContainerSpec, "AddTargetsToEffectContainerSpec" }, // 2288038325
		{ &Z_Construct_UFunction_URPGBlueprintLibrary_ApplyExternalEffectContainerSpec, "ApplyExternalEffectContainerSpec" }, // 51753438
	...
	IMPLEMENT_CLASS(URPGBlueprintLibrary, 2500657908);
