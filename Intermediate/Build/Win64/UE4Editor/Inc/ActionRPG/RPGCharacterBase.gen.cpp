...
// Cross Module References
	...
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_ActivateAbilitiesWithItemSlot();
	ACTIONRPG_API UScriptStruct* Z_Construct_UScriptStruct_FRPGItemSlot();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_ActivateAbilitiesWithTags();
	GAMEPLAYTAGS_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTagContainer();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetActiveAbilitiesWithItemSlot();
	ACTIONRPG_API UClass* Z_Construct_UClass_URPGGameplayAbility_NoRegister();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetActiveAbilitiesWithTags();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetCharacterLevel();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetCooldownRemainingForTag();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetHealth();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetMana();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetMaxHealth();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetMaxMana();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_GetMoveSpeed();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_OnDamaged();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_OnHealthChanged();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_OnManaChanged();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_OnMoveSpeedChanged();
	ACTIONRPG_API UFunction* Z_Construct_UFunction_ARPGCharacterBase_SetCharacterLevel();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ARPGCharacterBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ARPGCharacterBase_GetActiveAbilitiesWithItemSlot, "GetActiveAbilitiesWithItemSlot" }, // 3760086256
		{ &Z_Construct_UFunction_ARPGCharacterBase_GetActiveAbilitiesWithTags, "GetActiveAbilitiesWithTags" }, // 1405331018
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_SlottedAbilities = { "SlottedAbilities", nullptr, (EPropertyFlags)0x0020080000020015, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGCharacterBase, SlottedAbilities), METADATA_PARAMS(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_SlottedAbilities_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_SlottedAbilities_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_PassiveGameplayEffects = { "PassiveGameplayEffects", nullptr, (EPropertyFlags)0x0024080000010015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGCharacterBase, PassiveGameplayEffects), METADATA_PARAMS(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_PassiveGameplayEffects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_PassiveGameplayEffects_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_DefaultSlottedAbilities = { "DefaultSlottedAbilities", nullptr, (EPropertyFlags)0x0024080000000015, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGCharacterBase, DefaultSlottedAbilities), METADATA_PARAMS(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_DefaultSlottedAbilities_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_DefaultSlottedAbilities_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_GameplayAbilities = { "GameplayAbilities", nullptr, (EPropertyFlags)0x0024080000000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARPGCharacterBase, GameplayAbilities), METADATA_PARAMS(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_GameplayAbilities_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARPGCharacterBase_Statics::NewProp_GameplayAbilities_MetaData)) };
	...
	IMPLEMENT_CLASS(ARPGCharacterBase, 4179838436);
